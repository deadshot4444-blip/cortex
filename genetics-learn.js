...
const GEN_LESSONS = [
  ...
  {"id": "l-conjugation", "chapter": 7, "topic": "ch7-conjugation", "title": "How Bacteria Share Genes", "blurb": "Bacteria don't need sex or offspring to swap DNA. Discover the three clever routes they use to trade genes sideways, and why those tricks are fueling the antibiotic resistance crisis.", "steps": [{"kind": "teach", "body": "Imagine an infection that shrugs off a drug it has never encountered, because a neighboring microbe simply handed it the resistance gene. Bacteria reproduce by splitting in two, which only copies DNA <i>down</i> to descendants. Yet they can also pass genes <i>sideways</i> between unrelated cells, a process called <b>horizontal gene transfer</b>. This chapter unpacks the three routes they use: <b>conjugation</b>, <b>transformation</b>, and <b>transduction</b>."}, {"kind": "teach", "body": "In <b>conjugation</b>, two cells physically connect through a bridge called a <b>sex pilus</b>, and DNA flows in one direction only, from <b>donor</b> to <b>recipient</b>. The ability to donate is encoded by the <b>F factor</b>, a plasmid: cells carrying it are <b>F+</b> donors, and cells lacking it are <b>F-</b> recipients. Think of it less like mating and more like a one-way data cable plugged in by the cell that owns the F factor."}, {"kind": "ask", "prompt": "In a simple F+ x F- conjugation, the donor copies its F factor and ships the copy across the pilus. After transfer is complete, what is the mating type of the former recipient cell?", "reveal": "The recipient turns into a donor. Conjugation copies the F factor and sends the copy across, so the original donor stays F+ and the former recipient is now F+ too, fully equipped to conjugate with the next F- cell it meets. This is exactly why an F factor can sweep through a population like a chain letter. An Hfr or F' state would first require the F factor to interact with the chromosome, which a plain F+ x F- cross never does.", "choices": ["It stays F- because only the original donor can keep an F factor", "It becomes F+, because it now carries a copy of the F factor", "It becomes Hfr, with F integrated into its chromosome", "It becomes F', carrying extra chromosomal genes"], "answer": 1}, {"kind": "teach", "body": "Sometimes the F factor splices itself <i>into</i> the bacterial chromosome, creating an <b>Hfr cell</b> (\"high frequency of recombination\"). Now conjugation drags chromosomal genes along behind it in a fixed order, starting from where F sits. Because the connecting pilus usually breaks before the whole chromosome can transfer, the genes nearest the start enter first. If the integrated F later pops back out and accidentally grabs a few neighboring chromosomal genes, it becomes an <b>F' factor</b> that ferries those genes to the next recipient."}, {"kind": "ask", "prompt": "Researchers deliberately interrupt Hfr conjugation at timed intervals, blending the cells to snap the pilus, and record which donor genes reached recipients at each time point. Why does this 'interrupted mating' let them map gene order in minutes?", "reveal": "Because Hfr transfer is sequential and begins from a fixed point, a gene's time of entry mirrors its physical position. A gene that consistently shows up after 10 minutes sits closer to the origin of transfer than one that only appears after 25 minutes. By logging the entry time of each gene, scientists build a chromosome map whose 'distance' unit is literally minutes, an elegant trick that turns a stopwatch into a ruler."}, {"kind": "teach", "body": "The second route needs no contact at all. In <b>transformation</b>, a cell in a special receptive state called <b>competence</b> scoops up <b>naked DNA</b> floating in its surroundings, often released when other cells die and burst. The third route, <b>transduction</b>, is a delivery mistake: a <b>bacteriophage</b> (a virus that infects bacteria) accidentally packages bits of one host's DNA and injects them into the next bacterium it infects. In all three routes, the incoming DNA must <b>recombine</b> into the recipient's genome (or persist as a plasmid) to be inherited stably, and none of these processes is tied to reproduction."}, {"kind": "checkpoint", "q": "A bacterium acquires new DNA without ever touching another cell and without any virus involved; it simply absorbs DNA fragments left behind by lysed neighbors. Which process is this?", "options": ["Conjugation", "Transformation", "Transduction", "Hfr integration"], "answer": 1, "explain": "Taking up free, naked DNA from the environment is the defining feature of transformation, and it requires the cell to be in a competent state. Conjugation needs cell-to-cell contact through a pilus, and the virus-mediated route requires a bacteriophage as the carrier, so neither fits a contact-free, virus-free uptake of loose DNA."}, {"kind": "checkpoint", "q": "Why are conjugation, transformation, and transduction such a serious problem for the spread of antibiotic resistance?", "options": ["They only pass genes from parent cells to their own offspring during division", "They let resistance genes move horizontally between unrelated, even different-species bacteria", "They permanently delete resistance genes from bacterial populations", "They require the host to reproduce before any DNA can move"], "answer": 1, "explain": "All three mechanisms are forms of horizontal gene transfer, moving DNA sideways between cells that are not parent and offspring and that may not even be the same species. A resistance gene that arises in one bacterium can therefore jump into many others without waiting for reproduction, letting resistance spread far faster than mutation and vertical inheritance alone ever could."}]},
  {"id": "l-defense", "chapter": 7, "topic": "ch7-defense", "title": "Restriction & CRISPR Immunity: How Microbes Fight Viruses", "blurb": "Bacteria and archaea live under constant viral attack. This lesson builds up two defense systems — the blunt-but-fast restriction-modification system and the adaptive, memory-based CRISPR-Cas system — and reveals the elegant trick each uses to destroy invaders without destroying itself.", "steps": [{"kind": "teach", "body": "A single drop of seawater can hold ten million virus particles, and bacteriophages outnumber bacteria by roughly ten to one. To a microbe, the world is a relentless storm of foreign DNA trying to hijack its machinery. Survival demanded immune systems, and microbes evolved two very different ones: a fast, hardwired defense called <b>restriction-modification</b>, and a slower but adaptable one with actual memory, called <b>CRISPR-Cas</b>."}, {"kind": "teach", "body": "Start with the simpler weapon. A <b>restriction endonuclease</b> is a protein that scans DNA and cuts it wherever it meets a specific short sequence (often a palindrome such as GAATTC). Chop an invading phage's genome into fragments and it can no longer replicate. But this raises an obvious danger: the bacterium's <i>own</i> chromosome almost certainly contains that same sequence too."}, {"kind": "ask", "prompt": "If a restriction enzyme cuts every GAATTC it encounters, how does a bacterium avoid shredding its own chromosome, which surely carries GAATTC sites as well?", "reveal": "The cell protects itself through <b>modification</b>: a partner methyltransferase adds methyl groups to its own copies of the recognition sequence. Methylated sites are invisible to the restriction enzyme, so only <i>unmethylated</i> foreign DNA gets cut. This self-versus-nonself flag is the entire logic of restriction-modification. (Bacteria have no nucleus to wall off their DNA, the recognition sequence is identical in self and invader rather than misspelled, and the enzyme stays active at all times — which is why the other answers fail.)", "choices": ["It keeps the enzyme locked in a separate compartment away from its DNA", "It chemically tags (methylates) its own copies of that sequence so the enzyme ignores them", "Its own version of the sequence is spelled slightly differently from the invader's", "It only makes the enzyme after the phage has already finished replicating"], "answer": 1}, {"kind": "teach", "body": "Restriction-modification is powerful but dumb: it has no memory and meets every novel invader the same way. <b>CRISPR-Cas</b> is the upgrade — an <i>adaptive, heritable</i> immune system. Its centerpiece is the <b>CRISPR array</b>: a run of short, near-identical (often partially palindromic) <b>repeats</b> separated by unique <b>spacers</b>, where each spacer is a fragment of DNA captured from a virus the cell — or an ancestor — survived. Neighboring <b>cas genes</b> encode the Cas proteins that do the work. The array is essentially a genetic scrapbook of past enemies."}, {"kind": "teach", "body": "CRISPR immunity unfolds in three stages. In <b>adaptation</b>, Cas proteins grab a chunk of an invader's DNA (a <b>protospacer</b>) and paste it into the array as a brand-new spacer — this forms the memory. In <b>expression</b>, the array is transcribed into a long <b>pre-crRNA</b>, then processed into short individual <b>crRNAs</b>, each loaded onto one or more Cas proteins to build an effector complex. In <b>interference</b>, that complex uses its crRNA to base-pair with matching returning DNA, and Cas cleaves it."}, {"kind": "ask", "prompt": "Here's the catch. After adaptation, the invader's sequence now exists in TWO places: in the foreign DNA, and as a spacer in the cell's own CRISPR array. The crRNA matches both. What stops the effector complex from destroying the cell's own array?", "reveal": "The key is the <b>PAM</b> (protospacer-adjacent motif), a short sequence (for example NGG in many systems) lying immediately beside the protospacer <i>in the foreign DNA</i>. Cas demands a valid PAM before it will commit to cutting. Because the array stores only the spacer and NOT the flanking PAM, the cell's own CRISPR memory lacks the trigger — so the effector strikes the invader while sparing the array. (Methylation is the restriction-modification trick, the effector clearly does target DNA, and Cas freely accesses the chromosome — so the other answers miss the mark.)", "choices": ["The array is methylated for protection, just as in restriction-modification", "The crRNA base-pairs only with RNA, never with the DNA array", "A short PAM sequence sits next to the protospacer in the invader but is absent from the array spacer", "Cas proteins can only reach DNA located outside the chromosome"], "answer": 2}, {"kind": "interactive", "widget": "crispr", "instructions": "Step through the three stages of CRISPR-Cas immunity — adaptation, expression, and interference."}, {"kind": "checkpoint", "q": "Which feature is the defining advantage of CRISPR-Cas over restriction-modification?", "options": ["It cuts DNA at specific sequences", "It stores a heritable record of past invaders, enabling adaptive immunity", "It uses methylation to mark self DNA", "It works only against RNA viruses"], "answer": 1, "explain": "Both systems cleave foreign DNA, but only CRISPR-Cas builds a memory: it captures spacers from invaders and passes that record to daughter cells, so the lineage responds faster to a returning threat. That heritable, sequence-specific memory is what makes it adaptive. Restriction-modification, by contrast, is a fixed, inborn defense that never learns, and methylation is its hallmark rather than a CRISPR feature."}, {"kind": "checkpoint", "q": "A researcher finds a CRISPR spacer that perfectly matches a region of a phage genome, yet the system never cleaves the cell's own array. The most likely reason is:", "options": ["The array spacer is missing the adjacent PAM that the phage region carries", "The array spacer is transcribed in the wrong direction", "The cell methylates its array but not the phage DNA", "Cas proteins are degraded before they reach the array"], "answer": 0, "explain": "Cleavage requires both a crRNA match AND a valid adjacent motif. The invading DNA carries that motif right next to the matching region, but the stored spacer was copied without its flanking motif, so the targeting requirement is never met inside the array. This is precisely how the system tells a real invader apart from its own genetic memory. The remaining explanations either describe restriction-modification or invent mechanisms CRISPR does not use."}]},
  {"id": "l-viruses", "chapter": 7, "topic": "ch7-phages", "title": "Viruses: Lytic, Lysogenic & Retro", "blurb": "How viruses hijack cells, hide inside our DNA, and reinvent themselves fast enough to outrun our immune systems.", "steps": [{"kind": "teach", "body": "A virus sits right at the edge of being alive: a scrap of genetic code wrapped in protein, with no way to reproduce on its own. To make copies, it has to break into a living cell and convert that cell's machinery into a virus factory. The real story of this chapter is <i>strategy</i> — different viruses face the same problem (copy me) and solve it in startlingly different ways. We'll start with the viruses that infect bacteria, called <b>bacteriophages</b>, because they lay out the two classic playbooks most clearly."}, {"kind": "teach", "body": "The aggressive playbook is the <b>lytic cycle</b>. The phage <b>attaches</b> to the host, <b>injects its DNA</b>, and immediately hijacks the cell to mass-produce new viral parts. Those parts self-assemble into fresh phages, and finally the cell bursts open — <b>lysis</b> — releasing a swarm to hunt for new hosts. It's fast, destructive, and the host always dies. Phages that <i>only</i> run this program are called <b>virulent</b>."}, {"kind": "ask", "prompt": "The lytic cycle kills the host fast. But picture a phage infecting a starving bacterium in a nutrient-poor environment, where healthy host cells are scarce. Why might bursting the cell open right away actually be a poor survival bet for the virus?", "reveal": "If the phage lyses its host immediately but there are few healthy cells nearby to infect, the newly released phages have nowhere to go and simply fall apart. A smarter move is to lie low: integrate into the host genome and get copied passively every time the bacterium divides, riding along for free until conditions improve. That patient strategy is the <b>lysogenic cycle</b> — and it's precisely why temperate phages exist."}, {"kind": "teach", "body": "In the <b>lysogenic cycle</b>, the phage DNA inserts itself into the host chromosome and becomes a <b>prophage</b>. It does nothing destructive — it's simply replicated along with the host's own DNA at every cell division, quietly spreading through generations. Later, stress (classically a dose of <b>UV light</b>) can trigger <b>induction</b>: the prophage excises itself and flips into the lytic cycle. Phages that can take either path are called <b>temperate</b>."}, {"kind": "ask", "prompt": "To actually count phages in the lab, microbiologists spread bacteria into a smooth 'lawn' on a plate, add phages, and watch for clear spots called plaques. Each clear spot is a hole in the lawn where bacteria have died. What had to happen for one of those clear spots to form?", "reveal": "A <b>plaque</b> is the visible footprint of the lytic cycle playing out in miniature. One phage infects a cell, bursts it, and the released offspring infect the neighbors, which burst and release still more — a spreading wave of death that clears a circle in the lawn. Because each plaque traces back to a single original phage, counting plaques lets you count viruses.", "choices": ["A single bacterium grew faster than its neighbors", "A phage infected a cell, lysed it, and its offspring spread outward, killing nearby cells", "Antibiotics in the agar dissolved the bacteria", "The bacteria in that spot ran out of nutrients before the rest"], "answer": 1}, {"kind": "teach", "body": "Now flip to viruses that infect us. <b>Retroviruses</b> run the usual flow of genetic information backward. They carry <b>RNA</b> rather than DNA, and bring along an enzyme called <b>reverse transcriptase</b> that copies that RNA back into DNA. A second enzyme, <b>integrase</b>, then stitches this DNA into the host genome as a <b>provirus</b>. Their genome is compact: <b>gag</b> builds the capsid, <b>pol</b> encodes reverse transcriptase and integrase, and <b>env</b> makes the envelope proteins."}, {"kind": "teach", "body": "<b>HIV</b> is the infamous retrovirus. It targets <b>helper T cells</b> — the immune system's coordinators — so the very defense meant to fight it gets dismantled from the inside. Worse, reverse transcriptase is sloppy and makes copying errors constantly, so HIV <b>mutates fast</b>, staying a step ahead of both the immune response and many drugs. Notice the parallel: a prophage hiding in bacterial DNA and a provirus hiding in our DNA are running the same 'lie low inside the host genome' trick."}, {"kind": "checkpoint", "q": "What is the defining role of reverse transcriptase in a retrovirus's life cycle?", "options": ["It bursts the host cell open to release new viruses", "It copies the viral RNA genome into DNA so the genome can be integrated into the host", "It splices the viral DNA directly into the host chromosome", "It builds the protein capsid that surrounds the genome"], "answer": 1, "explain": "Retroviruses start with an RNA genome but need DNA to integrate into the host. Reverse transcriptase performs that backward step — RNA into DNA — which is exactly why these viruses are called 'retro.' Stitching the resulting DNA into the chromosome is the separate job of integrase, and the capsid is built from the gag gene's products."}, {"kind": "checkpoint", "q": "Influenza has a segmented RNA genome. When two different flu strains infect the same host cell at once and swap whole segments, producing a dramatically new virus, this is called:", "options": ["Antigenic drift, from gradual point mutations", "Antigenic shift, from reassortment of genome segments", "Lysogeny, from integrating as a prophage", "Induction, triggered by UV light"], "answer": 1, "explain": "Because flu's genome is split into separate segments, co-infection lets two strains physically reshuffle whole pieces into a brand-new combination — antigenic shift — and that abrupt, large change can spark a pandemic the population has no immunity to. It's distinct from antigenic drift, the slow accumulation of small point mutations that nudges the virus a little at a time."}]},
  {"id": "l-genmat", "chapter": 8, "topic": "ch8-genetic-material", "title": "What Makes Good Genetic Material", "blurb": "Before anyone knew DNA was the molecule of heredity, scientists had to reason out what any genetic material MUST be able to do — and most of them bet on the wrong molecule. Let's reconstruct that detective story.", "steps": [{"kind": "teach", "body": "Imagine you are a biologist in 1920. You know traits pass from parent to offspring, but you have no idea which molecule carries them. Before you can find the culprit, you need a <b>job description</b> — a list of everything the genetic material must be capable of doing. Get that list right, and you'll know what kind of molecule to hunt for."}, {"kind": "ask", "prompt": "Think about what heredity actually requires. What are the essential jobs the molecule of inheritance has to perform — what must it be able to do for life to work across generations?", "reveal": "Biologists eventually agreed on four non-negotiable requirements. The genetic material must (1) <b>store complex information</b> — enough to specify an entire organism; (2) <b>replicate faithfully</b>, so copies pass accurately to offspring; (3) be <b>expressible as a phenotype</b>, meaning the stored information can be read out (through transcription and translation) to build traits; and (4) have the <b>capacity to vary</b>, so that mutation and new combinations can fuel evolution. Any candidate molecule had to pass all four tests."}, {"kind": "teach", "body": "Notice the tension hidden in that list. Faithful copying demands <b>stability and accuracy</b> — the archive can't drift every generation. But the capacity to vary demands the opposite: the molecule <b>can't be so rigid that change is impossible</b>. Good genetic material walks a tightrope — stable enough to be a reliable record, yet flexible enough to occasionally change and feed evolution."}, {"kind": "ask", "prompt": "It's the 1920s through 1940s. Cells contain both proteins and nucleic acids. Proteins are built from 20 different amino acids; DNA is built from just 4 nucleotides. If you had to bet which molecule stores all of heredity's complex information, which would you pick — and why?", "reveal": "Most scientists bet on <b>protein</b>, and the reasoning was understandable for its time. With <b>20 amino acids</b> to arrange in endless sequences, proteins looked rich enough to encode the staggering complexity of a living organism. DNA's mere <b>4 nucleotides</b> seemed like too small an alphabet to write the whole book of life. The information-storage requirement is exactly what made protein the favorite — the variety argument felt decisive. They were wrong, but for a reason that made sense before the structure of DNA was understood.", "choices": ["Protein, because 20 different building blocks can encode far more variety than 4", "DNA, because 4 building blocks is obviously plenty", "Protein, because it is chemically more stable than DNA", "DNA, because it was already known to carry the genetic code"], "answer": 0}, {"kind": "teach", "body": "DNA's reputation got worse thanks to Phoebus Levene. His <b>tetranucleotide hypothesis</b> proposed that DNA was just the four nucleotides occurring in roughly equal amounts, locked into a fixed, monotonous repeating unit — picture ...ATGC-ATGC-ATGC... on and on. If DNA were truly that <b>repetitive and uniform</b>, it couldn't store complex, variable information at all. The idea made DNA look like a dull structural scaffold, not the keeper of heredity."}, {"kind": "ask", "prompt": "Which of the four requirements does the tetranucleotide hypothesis most directly seem to violate, and why does that matter so much?", "reveal": "It attacks the ability to <b>store complex information</b>, and it undercuts the <b>capacity to vary</b>. A molecule that is just one short motif repeated identically carries almost no information — every stretch looks like every other stretch, so there is nothing meaningful to read and nothing that can meaningfully change. The hypothesis turned out to be wrong: DNA's four bases occur in <b>any order, in essentially limitless sequences</b>, which is precisely what lets a four-letter alphabet encode enormous complexity. But while people believed DNA was monotonous, it simply didn't look like a serious candidate."}, {"kind": "teach", "body": "One more property quietly favors DNA as the long-term keeper of information: <b>chemical stability</b>. Compared with its cousin RNA, DNA is far less reactive — RNA carries an extra hydroxyl group on its sugar that makes it more prone to breaking down. A genome is meant to be a durable <b>archive</b> passed faithfully across generations, so a tougher, more stable molecule is exactly what you'd want for permanent storage, leaving the more fragile RNA better suited to short-lived, working copies."}, {"kind": "checkpoint", "q": "Why did many early-twentieth-century scientists favor protein over DNA as the genetic material?", "options": ["Protein's 20 amino acids seemed to offer enough variety to store complex hereditary information, while DNA's 4 nucleotides looked too simple", "Protein was the only molecule known to replicate", "DNA had not yet been discovered inside cells", "Protein was known to be more chemically reactive than DNA"], "answer": 0, "explain": "The decisive argument was about information capacity. With twenty different building blocks, proteins seemed rich enough to encode an organism's complexity, whereas DNA's four-letter alphabet — especially under the mistaken belief that those letters merely repeated monotonously — looked far too simple to carry heredity."}, {"kind": "checkpoint", "q": "Which statement best captures why DNA's chemical stability suits its biological role?", "options": ["Its relative stability compared with the more reactive RNA makes it well suited to be a faithful, long-term archive of genetic information", "Its instability lets it mutate constantly, which is the main purpose of genetic material", "Stability lets DNA be translated directly into protein without any intermediate", "Stability is the reason DNA contains 20 amino acids"], "answer": 0, "explain": "Genetic material must be copied faithfully and preserved across generations, so a durable, less reactive molecule is ideal for permanent storage. DNA is more chemically stable than RNA, which fits the role of a long-term archive, while the more fragile RNA tends to serve as the short-lived working copy."}]},
  {"id": "l-packaging", "chapter": 8, "topic": "ch8-packaging", "title": "Packing the Genome", "blurb": "Two meters of DNA folds into a nucleus a few microns wide. Let's unpack the supercoils, spools, and chemical switches that make it fit — and keep it readable.", "steps": [{"kind": "teach", "body": "A single human cell holds about two meters of <b>DNA</b> packed into a nucleus roughly one-hundred-thousandth that wide. Picture stuffing a strand of yarn the length of a football field into a marble — without snarling it so badly you can never find the part you need. Evolution's answer was layered compaction that stays both <i>organized</i> and <i>readable</i>. The first trick is twisting: a double helix can be <b>overwound</b> (extra twists, called <b>positive supercoiling</b>) or <b>underwound</b> (fewer twists, <b>negative supercoiling</b>). Like a phone cord that loops on itself when over-twisted, the molecule writhes to relieve the strain — but only if its ends are held fast. With free ends, the strain just spins away."}, {"kind": "ask", "prompt": "Why does a linear piece of DNA with two free ends NOT hold supercoils, while a bacterial circle or a protein-anchored loop does?", "reveal": "Supercoiling is stored torsional stress, and stress only lasts if it has nowhere to escape. A free end behaves like an open valve — the helix simply unspins until the strain is gone. To trap supercoils you need <b>constrained ends</b>: a covalently closed circle (as in bacteria) or DNA pinned down by proteins. That is why most cellular DNA can hold a supercoiled state.", "choices": ["Free ends let the strands rotate and release the twisting strain, so no tension is stored", "Free ends are chemically more stable than loops", "Linear DNA has no phosphate backbone to twist", "Circular DNA contains more base pairs"], "answer": 0}, {"kind": "teach", "body": "Cells actively manage twisting with enzymes called <b>topoisomerases</b>. They work by transiently <i>cutting</i> one or both strands, letting the DNA rotate or pass through the break, then <i>rejoining</i> it — adding or removing twists on demand. Most cellular DNA is kept slightly <b>negatively supercoiled</b> (underwound), which makes the strands easier to peel apart for replication and transcription and also helps it pack more compactly."}, {"kind": "ask", "prompt": "A cell needs to open its DNA for transcription. Would positive (overwound) or negative (underwound) supercoiling make that easier, and why?", "reveal": "Underwinding means the helix is already 'short' on twists, so locally separating the two strands relieves stored tension rather than fighting it. That is why <b>negative supercoiling</b> is the cell's default — it primes the DNA to be opened for reading and copying, while also taking up less space.", "choices": ["Positive, because overwinding pre-loosens the strands", "Negative, because underwinding stores tension that favors strand separation", "Neither — supercoiling does not affect strand opening", "Positive, because it adds more hydrogen bonds"], "answer": 1}, {"kind": "teach", "body": "Bacteria and eukaryotes pack differently. A typical bacterial chromosome is a single <b>circular</b> molecule lacking histones; it is twisted and bundled into looped domains in a dense region called the <b>nucleoid</b>. Eukaryotes instead build <b>chromatin</b> — DNA plus a large cast of proteins. Its core repeating unit is the <b>nucleosome</b>: about 147 base pairs of DNA wrapped roughly twice around a <b>histone octamer</b> (two copies each of H2A, H2B, H3, and H4). A separate linker histone, <b>H1</b>, clamps the DNA where it enters and exits. Strung together, nucleosomes resemble <i>beads on a string</i> — the first real level of packaging."}, {"kind": "ask", "prompt": "Histones are loaded with positively charged amino acids. Why is that charge chemically perfect for binding DNA?", "reveal": "DNA carries a strongly <b>negative</b> charge along its phosphate backbone. The <b>positively charged</b> histones grip it through electrostatic attraction — the molecular version of a magnet snapping onto steel. Hold onto this charge idea: it is the secret behind how cells later loosen or tighten chromatin on command.", "choices": ["DNA's sugar-phosphate backbone is negatively charged, so opposite charges attract", "Positive charges repel DNA, keeping it loosely held", "Histones use the charge to cut the DNA backbone", "The charge lets histones base-pair directly with the bases"], "answer": 0}, {"kind": "teach", "body": "Packaging then continues in tiers: the beads-on-a-string fiber coils into a thicker <b>30-nm fiber</b>, which folds into large <b>loops</b> anchored to a protein scaffold, condensing further into the <b>chromatid</b> seen in a metaphase chromosome. But packing is not uniform. <b>Euchromatin</b> is loosely packed, gene-rich, and actively transcribed — the 'open for business' regions. <b>Heterochromatin</b> is tightly condensed, gene-poor, and largely silent. A region's packing state is itself a major switch over whether its genes can be read."}, {"kind": "ask", "prompt": "Adding acetyl groups to histones (acetylation) neutralizes their positive charge. Predict what that does to chromatin and to gene activity.", "reveal": "Recall that histones grip DNA through positive-on-negative attraction. <b>Acetylation</b> cancels some of that positive charge, weakening the grip so the DNA loosens away from the histones. Looser, more open chromatin (euchromatin-like) is easier for transcription machinery to reach — so acetylation generally <i>promotes</i> gene expression. Some packaging marks like this are heritable yet leave the DNA sequence untouched; these are <b>epigenetic</b> changes. <b>DNA methylation</b> (often added to silence a region) is another classic example — copied to daughter cells, yet <i>reversible</i>. Epigenetics is how genetically identical cells become a neuron versus a skin cell.", "choices": ["Tightens chromatin and silences genes", "Loosens chromatin and tends to activate genes", "Cuts the DNA, deleting the genes", "Has no effect because charge does not matter for packing"], "answer": 1}, {"kind": "checkpoint", "q": "Which statement about the nucleosome is correct?", "options": ["About 147 bp of DNA wraps roughly twice around an octamer of two each of H2A, H2B, H3, and H4, with H1 clamping the linker", "It is a single circular DNA molecule with no associated proteins", "It consists of DNA wrapped around a single H1 histone", "It is formed by topoisomerases cutting DNA into 147-bp pieces"], "answer": 0, "explain": "The nucleosome is the basic bead of chromatin: roughly 147 base pairs of DNA wound about twice around a histone octamer (two each of H2A, H2B, H3, and H4), with the linker histone H1 securing the entry and exit DNA. A protein-free circular molecule describes a bacterial chromosome, not a nucleosome, and the remaining choices misstate both the histone composition and how nucleosomes form."}, {"kind": "checkpoint", "q": "Which change is epigenetic — heritable and reversible without altering the DNA sequence?", "options": ["DNA methylation that silences a gene region", "A point mutation swapping one base for another", "A deletion that permanently removes a chromosome arm", "A change in the genetic code's codon assignments"], "answer": 0, "explain": "Epigenetic marks such as DNA methylation can be inherited by daughter cells and later removed, all without changing the underlying base sequence. A point mutation is an actual sequence change, a deletion physically removes DNA, and the codon-assignment option describes something that does not occur in normal cells — none of which fit the definition of an epigenetic change."}]},
  {"id": "l-chromosome", "chapter": 8, "topic": "ch8-chromosome", "title": "Centromeres, Telomeres & Repeats", "blurb": "Why some of the most important DNA on a chromosome codes for nothing at all — and how the ends and the middle keep your genome from falling apart.", "steps": [{"kind": "teach", "body": "Imagine handing a cell a giant string of beads and asking it to copy them, split them evenly into two daughter cells, and never let the loose ends fray or stick together. To pull this off, a chromosome needs special landmarks that aren't really about <b>genes</b> at all. Two of the most critical — the <b>centromere</b> in the middle and the <b>telomeres</b> at the tips — are built largely from repetitive, non-coding DNA. This lesson is about how physical structure, not protein-coding, is what makes a genome workable."}, {"kind": "teach", "body": "The <b>centromere</b> is the chromosome's handle: it's where the <b>kinetochore</b> assembles and the <b>spindle</b> fibers grab on to drag sister chromatids apart in mitosis. It sits in a region of tightly packed <b>heterochromatin</b>, and in many species it's full of <b>highly repetitive</b> tandem (satellite) DNA. But here's the twist — there is <b>no universal centromere sequence</b> that every centromere shares."}, {"kind": "ask", "prompt": "If centromeres aren't defined by one specific DNA sequence, then what tells the cell 'THIS spot is the centromere, build the kinetochore here'?", "reveal": "Centromere identity is <b>epigenetic</b>, not sequence-based. At the centromere, the usual histone <b>H3</b> in the nucleosomes is swapped out for the variant <b>CENP-A</b>. That altered chromatin is the actual mark the cell reads to know where to assemble the kinetochore — which is why a given spot can stay 'the centromere' across cell generations even though no single DNA sequence is required.", "choices": ["A promoter sequence shared by all centromeres", "A special variant histone, CENP-A, that replaces normal H3 at that spot", "Simply the shortest stretch of DNA on the chromosome", "An enhancer that the spindle binds directly"], "answer": 1}, {"kind": "teach", "body": "Now the ends. Each <b>telomere</b> is a cap made of a short, <b>G-rich</b> sequence repeated over and over — in humans, <b>TTAGGG</b> stacked thousands of times. One strand runs longer than the other, leaving a single-stranded <b>3' G-overhang</b>. A protein complex called <b>shelterin</b> binds and folds this end so the cell doesn't mistake the natural chromosome tip for damage."}, {"kind": "ask", "prompt": "Why does a chromosome even NEED a protective cap? What would the cell's repair machinery do with a bare, unprotected DNA end?", "reveal": "A naked DNA end looks exactly like a <b>double-strand break</b> — an emergency the cell tries to fix by joining ends together. Without protection, chromosomes would get fused end-to-end and then shredded during division. <b>Shelterin</b> hides the natural tip so it reads as a proper end rather than as damage, preventing both fusion and degradation.", "choices": ["Nothing — free ends are perfectly stable on their own", "Treat it like a double-strand break and try to repair it or fuse it to another end", "Immediately build a brand-new gene there", "Convert it into a second centromere"], "answer": 1}, {"kind": "teach", "body": "Step back to the whole genome and you hit a puzzle: total genome size doesn't track how complex an organism seems. Some amphibians and plants carry far more DNA than humans do. This mismatch is the <b>C-value paradox</b> — and its resolution is that much of a large genome isn't unique genes but <b>repetitive</b> and non-coding sequence."}, {"kind": "teach", "body": "Genomic DNA sorts into rough classes by copy number. <b>Unique-sequence DNA</b> is present in one or a few copies — most protein-coding genes and gene families like the <b>beta-globin</b> cluster. <b>Moderately repetitive DNA</b> includes <b>rRNA</b> and <b>tRNA</b> genes plus interspersed repeats such as <b>SINEs</b> (e.g. <b>Alu</b>) and <b>LINEs</b>, many of which are remnants of mobile <b>transposons</b>. <b>Highly repetitive DNA</b> is short sequences tandemly repeated many thousands to millions of times, clustered at structural sites like centromeres and telomeres."}, {"kind": "ask", "prompt": "An Alu element appears scattered hundreds of thousands of times throughout the genome, both between and within genes, and is a leftover from a mobile genetic element. Which sequence class does it best fit?", "reveal": "<b>Alu</b> is a <b>SINE</b> — a short interspersed element scattered across the genome rather than clustered, and derived from transposons. That 'many copies, spread out, transposon-derived' profile is the signature of <b>moderately repetitive interspersed</b> DNA. It isn't unique (far too many copies) and it isn't the dense tandem arrays of highly repetitive satellite DNA.", "choices": ["Unique-sequence DNA", "Highly repetitive tandem (satellite) DNA", "Moderately repetitive interspersed DNA", "Centromeric satellite DNA"], "answer": 2}, {"kind": "checkpoint", "q": "Which statement about the centromere is correct?", "options": ["Its location is fixed by one DNA sequence shared by all species", "It is marked epigenetically by the histone variant CENP-A replacing H3", "It is the G-rich repeated cap that prevents end fusion", "It is made mostly of unique-sequence protein-coding genes"], "answer": 1, "explain": "Centromere identity is epigenetic: the variant histone CENP-A takes the place of H3 in centromeric nucleosomes, and the cell reads that chromatin mark to build the kinetochore. There's no universal centromere sequence; the G-rich cap describes telomeres; and centromeres are repetitive heterochromatin rather than unique coding DNA."}, {"kind": "checkpoint", "q": "Human telomeres consist of which feature?", "options": ["The tandem repeat TTAGGG ending in a single-stranded 3' G-overhang, capped by shelterin", "CENP-A nucleosomes that recruit the spindle", "The beta-globin gene family repeated in tandem", "rRNA genes that are moderately repetitive"], "answer": 0, "explain": "A telomere is the chromosome-end cap: many copies of the G-rich repeat TTAGGG ending in a single-stranded 3' overhang, with shelterin proteins binding so the tip isn't read as a double-strand break. CENP-A and the spindle belong to the centromere, while beta-globin and rRNA genes are coding or moderately repetitive sequences, not end caps."}]},
  {"id": "l-enzymes", "chapter": 9, "topic": "ch9-enzymes", "title": "The Replication Crew", "blurb": "Copying a bacterial genome is a relay race run by a pit crew of proteins, each with one specialized job. Meet the team that unzips, stabilizes, primes, builds, proofreads, and seals DNA — and learn why it almost never makes a mistake.", "steps": [{"kind": "teach", "body": "Imagine a bacterium that has to copy over 4 million base pairs flawlessly before it splits in two — and do it in well under an hour. No single protein could pull that off. Instead, evolution assembled a <b>replication crew</b>: a team of specialized proteins working at the <b>replication fork</b>, each handling exactly one job in the assembly line that duplicates the chromosome."}, {"kind": "teach", "body": "Replication starts at a fixed spot called the <b>origin</b>. The <b>initiator protein (DnaA)</b> binds there first and destabilizes the double helix, opening a small bubble of single-stranded DNA in an AT-rich stretch. Think of DnaA as the crew member who cracks open the zipper so everyone else can get to work."}, {"kind": "ask", "prompt": "Once DnaA opens that bubble, the two strands are still wound tightly into a helix everywhere else. What kind of machine do you think the cell needs next to actually run the fork forward and keep unwinding the DNA?", "reveal": "The fork needs <b>helicase</b>, the unwinding motor. It uses energy to travel along the DNA and break the hydrogen bonds holding the base pairs together, peeling the two strands apart so they can each serve as a template. Gluing the strands tighter would block replication, and the crew members that add bases come later — first you have to expose the template strands.", "choices": ["A protein that unwinds the double helix by breaking the hydrogen bonds between strands", "A protein that glues the two strands more tightly together", "A protein that chops the DNA into small fragments", "A protein that adds new bases to the growing strand"], "answer": 0}, {"kind": "teach", "body": "Two problems appear the instant helicase unwinds the DNA. First, the freshly separated single strands are sticky and tend to re-pair or fold up — so <b>single-strand-binding proteins (SSBs)</b> coat them and hold them open and ready. Second, unwinding a twisted helix builds up torsional strain ahead of the fork, like twisting a phone cord tighter. <b>DNA gyrase</b>, a type of <b>topoisomerase</b>, snips, swivels, and reseals the DNA to release that supercoiling so the fork doesn't seize up."}, {"kind": "teach", "body": "Now the templates are exposed and ready to be copied — but there's a catch. <b>DNA polymerases cannot start a new strand from scratch.</b> They can only <i>extend</i> an existing chain by adding to a free <b>3'-OH</b> group. So the crew calls in <b>primase</b>, an RNA-making enzyme that lays down a short <b>RNA primer</b> on the template. That primer provides the 3'-OH the polymerase needs as a starting handhold."}, {"kind": "ask", "prompt": "Why does the cell bother making the primer out of RNA — and then later have to come back and replace it with DNA — instead of just starting with DNA in the first place?", "reveal": "It comes down to the rule that <b>DNA polymerase can only add to an existing 3'-OH</b>; it cannot place the very first nucleotide on a bare template. <b>Primase</b> has no such restriction — it can begin a strand from nothing, but it builds with RNA. So the cell accepts a temporary RNA starter to get going, then cleans it up afterward. Using RNA also flags the primer as 'remove me later,' which helps keep replication accurate."}, {"kind": "teach", "body": "With a primer in place, the main builder takes over: <b>DNA polymerase III</b>. It races along the template synthesizing new DNA in the <b>5'-to-3' direction</b>, and it's also a proofreader — its <b>3'-to-5' exonuclease</b> activity backs up to remove a wrong base right after inserting it. Then <b>DNA polymerase I</b> steps in to remove the RNA primers and fill those gaps with DNA, and finally <b>DNA ligase</b> seals the leftover <b>nicks</b> in the sugar-phosphate backbone, stitching the new strand into one continuous piece."}, {"kind": "checkpoint", "q": "A mutant bacterium produces a DNA polymerase III that still synthesizes DNA normally but has completely lost its 3'-to-5' exonuclease activity. What is the most likely consequence?", "options": ["Replication cannot begin at the origin at all", "The mutation rate rises sharply because misincorporated bases are no longer proofread and removed", "RNA primers can no longer be made", "The two strands can no longer be unwound"], "answer": 1, "explain": "The 3'-to-5' exonuclease is the proofreading function: it removes a mismatched base immediately after it's inserted. Without it, wrong bases stay in place, so errors accumulate and the mutation rate climbs. Starting replication, making primers, and unwinding the helix are jobs handled by other crew members — the initiator, primase, and helicase — so those steps are unaffected."}, {"kind": "checkpoint", "q": "Bacterial replication achieves a fidelity of roughly one error per billion base pairs. Which combination best explains this extraordinary accuracy?", "options": ["Helicase unwinding plus single-strand-binding proteins", "Accurate base selection, polymerase proofreading, and post-replication mismatch repair working together", "DNA gyrase relieving supercoils plus ligase sealing nicks", "Primase making RNA primers plus DNA polymerase I removing them"], "answer": 1, "explain": "Fidelity is the product of three independent safeguards stacked together: the polymerase selects the correct complementary base accurately to begin with, it proofreads and excises mistakes as it goes, and a separate mismatch repair system scans the finished DNA afterward to catch what slipped through. Each layer multiplies the accuracy of the last. The other jobs are real and important, but they handle unwinding, strain relief, and primer cleanup rather than guarding the accuracy of the copied sequence."}]},
  {"id": "l-telomerase", "chapter": 9, "topic": "ch9-eukaryotic", "title": "Copying the Ends: The End-Replication Problem and Telomerase", "blurb": "Linear chromosomes have a built-in copying flaw at their tips. Discover why eukaryotes fire many origins exactly once, why DNA's ends keep getting shorter, and the clever RNA-toting enzyme that pushes back against the clock.", "steps": [{"kind": "teach", "body": "Imagine a painter who can only paint a floor by first laying down a strip of tape to stand on, then peeling it up at the very end. In the middle of a room that's no problem, but at the far wall the tape leaves a bare patch that never gets painted. Your <b>linear chromosomes</b> face exactly this dilemma every time a cell divides. To understand why, we first have to see why copying eukaryotic DNA is harder than copying a tidy bacterial loop."}, {"kind": "teach", "body": "A human cell must copy roughly two meters of DNA in just a few hours, so it cannot rely on a single starting point. Instead it launches replication from <b>many origins</b> scattered along each chromosome. But this creates a control problem: each stretch of DNA must be copied <b>exactly once per cell cycle</b> — no piece left out, and no piece copied twice. Over-copying would scramble gene dosage; under-copying would lose information."}, {"kind": "ask", "prompt": "If a cell has hundreds of origins that each need to fire once and only once, what would go wrong if an origin were allowed to re-fire later in the same S phase?", "reveal": "Re-firing an origin would duplicate the same DNA segment twice in one cycle, leaving that region over-represented while the rest of the genome sits at the normal two copies. This unbalanced gene dosage is dangerous and can drive genomic instability. So the cell needs a hard rule: an origin fires once, then stays shut until the next cycle.", "choices": ["The chromosome would simply finish replicating faster with no consequence", "That region would be copied more than once, giving the cell extra, unbalanced copies of those genes", "The cell would skip that region entirely", "Nothing — extra copies are always discarded automatically"], "answer": 1}, {"kind": "teach", "body": "Cells enforce the once-per-cycle rule through <b>licensing</b>. In G1, before DNA synthesis begins, the <b>origin-recognition complex (ORC)</b> marks each origin and helps load the <b>MCM2-7 helicase</b> onto the DNA — like issuing a one-time permit. When S phase arrives, the helicase activates and the origin fires. Crucially, once an origin has fired, <b>re-licensing is blocked</b> for the rest of the cycle, so no origin can be reloaded until the cell resets in the next G1."}, {"kind": "teach", "body": "Now back to the ends. DNA polymerase has two unbreakable habits: it can only <b>build in the 5' to 3' direction</b>, and it cannot start from scratch — it needs an <b>RNA primer</b> to begin. On the lagging strand, synthesis happens in short pieces, each kicked off by its own primer. When those RNA primers are later removed, DNA fills the gaps... except for the primer at the very <b>5' end</b> of a new strand, where there is no upstream DNA to extend from."}, {"kind": "ask", "prompt": "The terminal RNA primer at the 5' end of a newly made lagging strand gets removed, leaving a gap. Why can't DNA polymerase just fill that gap the way it fills the others?", "reveal": "Every interior gap gets filled because polymerase extends from the 3' end of the neighboring fragment into the gap. But the terminal gap sits at the chromosome's very tip — there is no fragment beyond it to supply a 3' end to build from. With nothing to extend, the gap stays empty. This is the <b>end-replication problem</b>: each round of copying leaves the new strand a little shorter.", "choices": ["The gap is too small to detect", "There is no 3' end upstream of the gap for polymerase to extend from, and polymerase can only add onto an existing 3' end", "DNA polymerase runs out of nucleotides at the end", "Helicase has already left, so the strand is sealed"], "answer": 1}, {"kind": "teach", "body": "Left unchecked, this means chromosomes would shrink a bit with every division, eventually eating into essential genes. Eukaryotes buffer against this with <b>telomeres</b> — long stretches of repetitive, G-rich sequence capping each chromosome end. Telomeres hold no protein-coding genes, so they act as a sacrificial fuse: the cell can afford to lose a little telomere each cycle. But a fuse only buys time; something has to rebuild it."}, {"kind": "teach", "body": "Enter <b>telomerase</b>, a <b>ribonucleoprotein</b> — part protein, part RNA. Its trick is that it carries its <b>own RNA template</b> built right in. Telomerase uses that internal template to extend the <b>G-rich strand</b> outward, adding fresh repeats to the chromosome tip. The lengthened overhang then gives the ordinary lagging-strand machinery enough room to lay down a primer and fill in, so the chromosome no longer net-shortens."}, {"kind": "ask", "prompt": "Telomerase is unusual among the enzymes of replication. What single feature most directly lets it solve the end problem?", "reveal": "Ordinary polymerases must read an existing DNA template — and that's exactly what runs out at the chromosome end. Telomerase sidesteps this by hauling its own short RNA template, so it can keep dictating and adding the telomeric repeat even where no template DNA remains. That self-contained template is what makes it a specialized reverse transcriptase for the ends. (It still works off the chromosome's existing 3' overhang, so it isn't primer-free.)", "choices": ["It copies DNA without ever needing any kind of primer or 3' end to start from", "It brings along its own internal RNA template that specifies the repeat sequence it adds", "It works only in the 3' to 5' direction", "It removes telomeres so the chromosome can reset"], "answer": 1}, {"kind": "teach", "body": "Telomerase isn't running everywhere. It is robustly active in <b>germ cells and stem cells</b>, which must preserve full-length chromosomes across generations and through many divisions. Most ordinary <b>somatic cells</b> keep it low or off, so their telomeres gradually erode — a process tied to <b>cellular aging</b> and to the limited number of times such cells can divide. Tellingly, the large majority of <b>cancers (around 85-90%)</b> switch telomerase back on, granting tumor cells the unlimited division that healthy somatic cells lack."}, {"kind": "checkpoint", "q": "A researcher has a somatic cell line whose chromosomes shorten with each division until the cells stop dividing. They then engineer the cells to express active telomerase. What is the most likely result?", "options": ["Chromosomes keep shortening at the same rate because telomerase has no role at the ends", "Telomere length is maintained, and the cells can keep dividing past their former limit", "Origins stop firing, halting replication entirely", "The cells copy each chromosome twice per cycle"], "answer": 1, "explain": "The shortening came from the end-replication problem with no enzyme rebuilding the tips. Supplying active telomerase restores the ability to add telomeric repeats, maintaining length and lifting the shortening-based brake on division — exactly how it extends replicative lifespan and why reactivating it is common in cancer. Origin firing and copy number per cycle are unrelated to this fix."}, {"kind": "checkpoint", "q": "Which statement correctly pairs a mechanism with the problem it solves in eukaryotic replication?", "options": ["Licensing by ORC and MCM2-7 fills the terminal gap left after primer removal", "Telomerase ensures each origin fires only once per cell cycle", "Licensing ensures each origin fires once per cycle; telomerase counteracts end-shortening of linear chromosomes", "Both licensing and telomerase exist mainly to speed up replication"], "answer": 2, "explain": "These are two separate challenges with two separate fixes. Loading the helicase in G1 and then blocking re-licensing keeps every origin to a single firing per cycle, preventing over- or under-replication. Telomerase instead addresses the unavoidable gap at the tips of linear DNA, adding repeats so chromosomes don't progressively erode. Conflating them confuses origin control with end maintenance."}]},
  {"id": "l-recomb", "chapter": 9, "topic": "ch9-recombination", "title": "Crossing Over Up Close", "blurb": "Peek inside meiosis to see how two chromosomes physically swap DNA — and why not a single letter of the genetic code gets lost in the trade.", "steps": [{"kind": "teach", "body": "You already know that crossing over shuffles alleles and lets us build genetic maps. But how do two enormous DNA molecules actually <b>trade pieces</b> without dropping or duplicating any information? The answer is a precise molecular cut-and-paste called <b>homologous recombination</b> — the same machinery your cells use to repair broken DNA. In this lesson we'll watch it happen one strand at a time."}, {"kind": "teach", "body": "Recombination begins when two <b>homologous duplexes</b> (matching chromosomes, one inherited from each parent) line up side by side. Single strands from the two homologs base-pair with each other, creating a stretch of <b>heteroduplex DNA</b> — a double helix whose two strands come from <i>different</i> chromosomes. Because the homologs share nearly the same sequence, these paired strands fit together almost perfectly, which is exactly why homology is required."}, {"kind": "ask", "prompt": "Heteroduplex DNA means one strand came from each homolog. Why does the cell get away with pairing strands from two different chromosomes — what makes that even possible?", "reveal": "Homologs carry the same genes in the same order, so their sequences are almost identical. That near-identity is what lets a strand from one chromosome form a stable, complementary double helix with a strand from the other. This is why recombination is called <b>homologous</b> — without matching sequence, the strands couldn't pair and the whole process would fail.", "choices": ["The two homologs have nearly identical sequences, so the strands are complementary enough to base-pair", "DNA strands will pair with any other strand regardless of sequence", "Special enzymes rewrite one strand to match the other before pairing", "The strands are held together by the chromosome's protein scaffold, not base pairing"], "answer": 0}, {"kind": "teach", "body": "Where the strands cross from one duplex to the other, they form an X-shaped structure called a <b>Holliday junction</b> — the physical crossover point. This junction isn't locked in place: it can slide along the paired DNA, swapping which base pairs belong to the heteroduplex. This sliding is called <b>branch migration</b>, and it lengthens the region where the two homologs have exchanged strands."}, {"kind": "ask", "prompt": "A Holliday junction is eventually cut apart ('resolved') to separate the two chromosomes, and there are two different orientations in which those cuts can be made. Why should the cell care which orientation it uses — both of them do separate the DNA, after all?", "reveal": "Here's the punchline of recombination: the <i>orientation</i> of the cuts decides the outcome. Resolving the junction one way leaves the flanking DNA in its original arrangement — a <b>noncrossover</b> product. Cutting the other way reciprocally exchanges the flanking arms — a <b>crossover</b> product, where each chromosome now carries a chunk of its partner. Same junction, two cutting choices, two genetically different results."}, {"kind": "teach", "body": "So how does this all get started in meiosis? The favored explanation is the <b>double-strand-break model</b>. A protein called <b>Spo11</b> deliberately cuts <i>both</i> strands of one chromosome at a single site. The broken ends are trimmed back (resected) to leave overhanging <b>3' single strands</b>, one of which invades the intact homolog and pairs with it. New DNA synthesis then copies the homolog as a template, and the process can build <i>two</i> Holliday junctions that are later resolved into crossover or noncrossover products."}, {"kind": "checkpoint", "q": "In the double-strand-break model of meiotic recombination, what is the role of the protein Spo11?", "options": ["It introduces the initiating double-strand break by cutting both strands of one chromosome", "It seals the Holliday junctions at the end to finish the exchange", "It pulls the homologous chromosomes apart during anaphase", "It proofreads new DNA to prevent any sequence from being changed"], "answer": 0, "explain": "Spo11 is the trigger of the whole process: it deliberately breaks both strands of one duplex, creating the double-strand break that then gets resected to 3' single strands. Those single strands invade the homolog, set up the Holliday junctions, and the rest of recombination follows from there."}, {"kind": "checkpoint", "q": "After a crossover finishes, why is no genetic information lost or gained — even though both strands of one chromosome were cut?", "options": ["The intact homolog serves as a template, so any gap is filled by copying matching sequence", "The cell deletes whatever extra DNA appears so the totals stay balanced", "Crossing over only moves proteins, never actual DNA sequence", "Lost bases are replaced with random nucleotides that average out over many cells"], "answer": 0, "explain": "Recombination is conservative because it's homology-guided. When the ends are resected and gaps appear, DNA synthesis copies the undamaged homolog — which carries the same genes — so every base that's removed is rebuilt from a matching template. The chromosomes swap which parental alleles they carry, but the total genetic content is fully preserved."}]},
];
