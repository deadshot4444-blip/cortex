...
const GEN_BANK = GEN_DIAGRAMS.concat(GEN_GENERATED).concat(GEN_GENERATORS);
...
function genRunQuestion(run) {
  ...
  const choose = (btn) => {
    ...
    if (right) {
      ...
      if (run.mode === 'chapter' || run.mode === 'topic') {
