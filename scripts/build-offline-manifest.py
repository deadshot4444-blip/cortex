...
specs = [
    ...
    ('dat', 'DAT preparation', '/dat', 'Timed science drills, perceptual-ability generators, quantitative and reading practice, mistake review and a date-driven schedule. Independent subject review is pending.',
